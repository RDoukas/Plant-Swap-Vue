    ...
    <div id="wrapper">
      <div class="main">
        <div
          ...
          style="background-image:url(/assets/images/backgrounds/tropical.jpg)"
        ...
        >
          ...
          >
            <div class="container-fluid">
              <h1 class="text-white">
                <span>Welcome to Chicago Plant Swap</span>
              </h1>
            </div>
          </div>
          <!-- End .vcenter-content -->
            ...
            <div class="row">
              <div class="col-md-6">
                <h3 class="title custom">
                  About <span class="light text-custom">Us</span>
                </h3>
                <p>
                  Chicago Plant Swapp is an app that connects plant lovers
                  across the Chicagoland area. All plants are by donation and
                  there is no charge for plants.
                </p>
                <p>
                  After having an overflowing collection of plants we decided
                  what better than to share them with other plant lovers who we
                  know will love our babies! You can swap anything from fully
                  potted plants to propogations to even seeds!
                </p>
              </div>
              <!-- End .col-md-6 -->
